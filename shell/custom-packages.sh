...
#
# 与 SHHOME 对齐说明：
# - 已优先启用：adguardhome / netwizard / lucky / tailscale / ddns-go / watchdog
# - 若构建报 Unknown package，会在 Action 日志中提示；通常是上游源或第三方 store 版本变动导致。
